...
const links = [
    {
        ...
        modalInfo: {
            ...
            listImages: [
                '/images/badlands/list/badlands_01.png',
                '/images/badlands/list/badlands_02.png',
                '/images/badlands/list/badlands_03.png',
                '/images/badlands/list/badlands_04.png',
            ]
        }
    },
    {
        ...
        modalInfo: {
            ...
            listImages: [
                '/images/glacial_frontier/list/glacial_frontier_01.png',
                '/images/glacial_frontier/list/glacial_frontier_02.png',
                '/images/glacial_frontier/list/glacial_frontier_03.png',
                '/images/glacial_frontier/list/glacial_frontier_04.png',
            ]
        }
    },
    {
        ...
        modalInfo: {
            ...
            listImages: [
                '/images/sundered_grove/list/sundered_grove_01.png',
                '/images/sundered_grove/list/sundered_grove_02.png',
                '/images/sundered_grove/list/sundered_grove_01.png',
                '/images/sundered_grove/list/sundered_grove_02.png',
            ]
        }
    },
    {
        ...
        modalInfo: {
            ...
            listImages: [
                '/images/sky_citadel/list/sky_citadel.png',
                '/images/sky_citadel/list/sky_citadel.png',
                '/images/sky_citadel/list/sky_citadel.png',
                '/images/sky_citadel/list/sky_citadel.png',
            ]
